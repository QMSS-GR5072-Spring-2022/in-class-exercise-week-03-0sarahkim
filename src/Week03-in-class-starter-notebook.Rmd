...
[INSERT YOUR NOTES HERE]
Tibbles: modern ver on data frames - dataframes w/o all the prior issues(keep strings as string, not factors, etc)
--created by tibble()
...
:^ makes you print n rows instead of the default option of 10 
...
[INSERT YOUR NOTES HERE]
Tibbles are strict about subsetting - it always returns another tibble
